...
|------|-------------|------|---------|:--------:|
| <a name="input_apigee_org_billing_type"></a> [apigee\_org\_billing\_type](#input\_apigee\_org\_billing\_type) | Billing configuration for the Apigee organization:<br>- EVALUATION: Free tier with limitations (default)<br>- PAYG: Pay-as-you-go billing based on API calls<br>- SUBSCRIPTION: Fixed price subscription with included API call quota | `string` | `"EVALUATION"` | no |
